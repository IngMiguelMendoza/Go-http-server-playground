...
func main() {
	...
	*/
	...
	mux.HandleFunc("POST /api/users", apiCfg.apiUsersPostHandler)
	mux.HandleFunc("PUT /api/users", apiCfg.apiUsersUpdateHandler)
	...
	mux.HandleFunc("DELETE /api/chirps/{chirpID}", apiCfg.apiDeleteChirpByIdHandler)
